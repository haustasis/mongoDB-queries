...
db.restaurants.find({$and:[{"cuisine": {$ne: "American "} },{"grades.grade": {$eq: "A"}}, {"borough": {$ne: "Brooklyn"} }]},{_id:0, "cuisine": 1, "grades.grade": 1, "borough": 1}).sort( { "cuisine": 1 })
...
db.restaurants.find({"borough": "Bronx", $or: [{"cuisine": {$regex: /american/i}},{"cuisine": {$regex: /chinese/i}}]})
...
db.restaurants.find({$or: [ {$nor: [{"cuisine": {$regex: /american/i}},{"cuisine": {$regex: /chinese/i}}]},{"name": {$regex: /^Wil/}}] },{"_id":0, "restaurant_id": 1,  "name": 1, "borough": 1, "cuisine": 1})
db.restaurants.find({"grades":{$elemMatch: {"date":{$eq:ISODate("2014-08-11T00:00:00Z")}, "grade": "A", "score": 11}}},{"_id":0, "restaurant_id":1, "name":1, "grades":1})
db.restaurants.find({"grades.1.date": {$eq:ISODate("2014-08-11T00:00:00Z")}, "grades.1.grade": "A", "grades.1.score":{$gt:9}},{"_id":0, "restaurant_id":1, "name":1, "grades":1})
